  ...
  return (
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      ...
      <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
        ...
        opportunities, or anything tech-related!
      </p>
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6 justify-center">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="mailto:ominduviva@gmail.com" className="text-muted-foreground hover:text-primary transition-colors ">
                    ominduviva840@gmail.com
                </a>
              </div>
            </div>
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <a href="tel:+94 77 878 4516" className="text-muted-foreground hover:text-primary transition-colors ">
                    +94 77 878 4516
                </a>
              </div>
            </div>
          ...
          <div className="pt-8">
            ...
            <div className="flex space-x-4 justify-center">
                <a href="https://www.linkedin.com/in/omindu-vivandith-56b63b2b5/" target="_blank" >
                    <Linkedin />
                </a>
                <a href="https://www.instagram.com/omi_du/" target="_blank">
                    <Instagram />
                </a>
                <a href="https://github.com/Omindu1015" target="_blank">
                    <Github />
                </a>
            </div>
        ...
        >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    <textarea id="message" name="message" required className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary resize-none h-32"
